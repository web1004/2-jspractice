(function(){
  ...
  const addBookmarkItem = () => {
    ...
    let createAt = Date.now(); //현재의 날짜(1970.1.1 0시0분0초부터 이 순간까지 경과된 밀리초를 나타내는 숫자값을 얻어올수 있음)
...
// 3번까지 해보고 추가를 해보면 로컬스토리지에 저장되는걸 확인